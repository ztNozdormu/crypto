...
#[cfg(test)]
#[bench]
fn bench_aes128_enc_aesni(b: &mut test::Bencher) {
...
#[cfg(test)]
#[bench]
fn bench_aes128_dec_aesni(b: &mut test::Bencher) {
    let key = hex::decode("000102030405060708090a0b0c0d0e0f").unwrap();
...
#[cfg(test)]
#[bench]
fn bench_aes192_dec_aesni(b: &mut test::Bencher) {
    let key = hex::decode("000102030405060708090a0b0c0d0e0f1011121314151617").unwrap();
